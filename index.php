...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-130770515-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-130770515-1');
    </script>
    ...
    <meta property="og:title" content="FRAMMI Awards">
    <meta property="og:description" content="Les FRAMMI Awards sont un Festival de R&eacute;alisations Multim&eacute;dia r&eacute;serv&eacute;s aux &eacute;tudiants MMI le but de faire d&eacute;couvrir des talents naissants, promouvoir leur travail le temps d&rsquo;un soir face &agrave; un public d&rsquo;amateurs mais aussi de professionnels.">
    <meta property="og:url" content="http://frammi.fr">
    <meta property="og:image" content="http://frammi.fr/images/favicon/facebook/og-image.jpg">
    ...
    <div class="inscriptions_overlay" id="inscriptions_overlay"></div>
      <div class="inscriptions_form" id="inscriptions_form">
        ...
        <div class="formblock">
            ...
            <input type="text" name="titre" id="titrerea" placeholder="Titre de la réalisation de l'oeuvre" />

            <input type="text" name="lien" id="linktel" placeholder="Lien de téléchargement de l'oeuvre (WeTransfer, FromSmash, ...)" />

            <textarea name="description" placeholder="Description de l'oeuvre" id="descta" rows="5"></textarea>
    ...
    <div class="inscriptions" id="insc3">
            ...
            <div class="wrap">
                ...
                <div class="inscriptions_right">
                    ...
                    <a href="reglement_frammi.pdf" target="_blank" ><button class="btn_reglement"><h2>RÉGLEMENT</h2></button></a>
            ...
            <div class="wrap">
                ...
                <h1>_4 CATÉGORIES, <span>4 JURYS</span></h1>
                    ...
                    <p id="categories_desc">
                        ...
                        Cette année, c'est nouveau ! La compétition est ouverte à <span>tous les créatifs</span> de MMI, avec <span>3 nouvelles catégories</span>, en plus de l'audiovisuel : le <span>graphisme</span>, la <span>communication</span> et la <span>programmation</span>. Nouvelle catégorie veut dire nouveau jury, pour évaluer les créations à leur juste valeur. 
                    </p>
                ...
                <div class="categories2">
                    ...
                    <div class="com">
                        ...
                        <img src="images/perez.png" id="imgcategorie">

                        <h2>Romain <span>Perez Canales</span></h2>

                        <p>

                            Romain a terminé son DUT SRC en 2014 puis a fait une licence pro Communication et Marketing à l'école Écoris. Depuis, il travaille pour des clients comme le FC Sochaux-Montbéliard ou Antoine Griezmann et travaille actuellement dans l'entreprise BeNN.
                    ...
                    <div class="graph">
                        ...
                        <img src="images/bois.png" id="imgcategorie">

                        <h2>Gabriel <span>Bois</span></h2>

                        <p>

                            Après avoir décroché son DUT SRC en 2011, Gabriel a fait une licence pro concepteur et intégrateur web et multimédia à Paris. Depuis il a travaillé comme développeur web dans plusieurs agences avant de travailler avec Damien dans leur propre agence, Zeecom.
                    ...
                    <div class="prog">
                        ...
                        <img src="images/glauda.png" id="imgcategorie">

                        <h2>Damien <span>Glauda</span></h2>

                        <p>

                            Ayant un parcours similaire à celui de Gabriel Bois, Damien s'est également rendu à Paris après son DUT SRC pour étudier le design graphique. Depuis, il s'est associé avec Gabriel et ensemble, ils ont fondé leur agence à Chambéry : Zeecom.
                    ...
                    <div class="av">
                        ...
                        <img src="images/tardy.png" id="imgcategorie">

                        <h2>Baptiste <span>Tardy</span></h2>

                        <p>

                            <!--Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis-->
                            
                            Après avoir obtenu un DUT MMI en 2016, Baptiste est parti faire ses études pendant 1 an au Canada. En revenant, il continue ses études avec un bachelor concepteur designer graphique à Aries. Aujourd'hui, il occupe le poste de motion Designer dans l'agence NewQuest.
        ...
        <div class="wrap" id="footer5">
            ...
            <div class="contact">
                ...
                <div class="logos">
                    ...
                    <a href="http://mmi.univ-savoie.fr/site/" alt="MMI Chambéry"><img src="images/logoMMI.png" id="logosmmi"></a><a href="http://www.iut-chy.univ-savoie.fr/index.php" alt="IUT de Chambéry"><img src="images/logoIUT.png"  id="logosmmi"></a>
